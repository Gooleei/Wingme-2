 ...
 */
export function triggerSponsorAd(zoneKey: keyof typeof ACTIVE_AD_ZONES = 'ZONE_458074', onComplete?: () => void): void {
  const zone = ACTIVE_AD_ZONES[zoneKey] || ACTIVE_AD_ZONES.ZONE_458074;
  sound.playClick();
  ...
  try {
    if (typeof window !== 'undefined' && (window as any).a3klsam && typeof (window as any).a3klsam.init === 'function') {
      (window as any).a3klsam.init(Number(zone.tagId) || 458074);
    }
  } catch (e) {
