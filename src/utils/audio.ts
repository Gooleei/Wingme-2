// Web Audio Synthesizer for 60FPS Arcade sound effects & ambient audio
...
class SoundManager {
  ...
  public playJump(isDouble: boolean = false) {
    ...
    try {
      ...
      osc.type = isDouble ? 'sine' : 'triangle';
      const startFreq = isDouble ? 480 : 320;
      const endFreq = isDouble ? 960 : 640;
